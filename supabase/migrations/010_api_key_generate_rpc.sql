-- Depozitka Core - RPC pro generování API klíčů z admin UI (v10)
...
is 'Admin RPC: vygeneruje API klíč pro marketplace, uloží bcrypt hash, vrátí key ID.';
